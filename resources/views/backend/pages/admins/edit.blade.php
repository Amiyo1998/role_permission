        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('users.index')}}">All Admins</a></li>
                        ...
                        <form action="{{ route('admins.update', $admin->id)}}" method="POST">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <input class="form-control" type="text"  id="name" name="name" placeholder="Enter name" value="{{ $admin->name}}">
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    <label for="email" class="col-form-label">Admin Email</label>
                                    <input class="form-control" type="email"  id="email" name="email" readonly value="{{ $admin->email}}">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6 col-sm-12">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 col-sm-6">
                                    ...
                                    <input class="form-control" type="username"  id="username" name="username" placeholder="Enter username" value="{{ $admin->username}}">
                                </div>
                            </div>
